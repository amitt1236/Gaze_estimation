...
def gaze(frame, points):
    '''
    2D image points.
    relative takes mediapipe points that is normelized to [-1, 1] and returns image points
    at (x,y) format
    '''
    ...
    '''
    2D image points.
    relativeT takes mediapipe points that is normelized to [-1, 1] and returns image points
    at (x,y,0) format
    '''
    ...
    '''
    Eye_ball_center_right = (-29.05,32.7,-39.5)
    ...
    try:
        ...
        _ ,transformation, _ = cv2.estimateAffine3D(image_points1, model_points) # image to world tramsformation
        ...
        (head_pose, jacobian) = cv2.projectPoints((int(pupil_world_cord[0]), int(pupil_world_cord[1]), int(40)), rotation_vector,
                                                        translation_vector, camera_matrix, dist_coeffs)
        ...
        p3 = (int(left_pupil[0]), int(left_pupil[1]))
        p4 = (int(gaze[0]) , int(gaze[1]))
        cv2.line(frame, p1, p2, (0, 0, 255), 2)
        cv2.line(frame, p3, p4, (0, 0, 0), 2)
    except:
        pass
